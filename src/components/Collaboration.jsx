      ...
      <div className="container lg:flex">
        <div className="max-w-[25rem]">
            <h2 className="h2 mb-4 md:mb-8">
                Chat con IA para una colaboración perfecta
            </h2>
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-4">
            <p className="body-2 mb-12 mt-12 text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem] text-center lg:mx-auto">
                {collabText}
            </p>

            <div className="relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 sclale:75 md:scale-100 ">
